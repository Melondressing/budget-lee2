...
// Google 로그인 시작 (사용자를 Google 로그인 페이지로 리디렉션)
    ...
    return c.html(`
      <html>
        <body>
          ...
          <p>Please set GOOGLE_CLIENT_ID in .dev.vars file</p>
          <h2>Setup Instructions:</h2>
          <ol>
            <li>Go to <a href="https://console.cloud.google.com/apis/credentials" target="_blank">Google Cloud Console</a></li>
            <li>Create a new OAuth 2.0 Client ID</li>
            <li>Set authorized redirect URI: <code>${redirectUri}</code></li>
            <li>Copy Client ID and Client Secret to .dev.vars file</li>
          </ol>
...
// Google OAuth Callback (Google이 인증 후 리디렉션하는 URL)
...
<head>
    ...
    <meta name="description" content="Budget Lee personal finance manager">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div id="user-section" class="flex items-center gap-4">
                    ...
                    <div id="login-section" class="hidden">
                        <a href="/api/auth/google" class="flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors shadow-sm">
                    ...
                    <div id="user-info-section" class="hidden items-center gap-3">
                        ...
                        <button id="logout-btn" class="px-3 py-2 text-sm text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg transition-colors">
